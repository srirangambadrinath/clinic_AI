...
      await db.saveReport({
        visitId: newVisit.id,
        reportType: analysis.reportType || 'Unknown Report', 
        extractedText: analysis.extractedText || '',
        findings: analysis.findings || '',
        impression: analysis.impression || '',
        doctors_summary: analysis.doctors_summary || [], 
        imageBase64: imageBase64
      });

      const adviceFromSummary = analysis.doctors_summary 
        ? ['Summary of Report Findings:', ...analysis.doctors_summary, 'Review report details.'] 
        : ['Review report details.'];

      await db.savePrescription({
        visitId: newVisit.id,
        diagnosis: analysis.impression ? [analysis.impression] : [],
        symptoms: [],
        // 🌟 UPDATE: Use currentVitals for reports too
        vitals: currentVitals,
        medicines: [],
        investigations: analysis.findings ? [`Report Findings (${analysis.reportType || 'Report'}): ${analysis.findings}`] : [],
